...
wu_train_naive_baseline:
	python3 ./naive_baseline/main.py --gpu $(GPU) --cinnamon-data-path $(CINNAMON_DATA_PATH) --lr 1e-5 --epoch 35 --batch-size 4 --num-workers 8 --save-path ./naive_baseline/ckpt/ 
